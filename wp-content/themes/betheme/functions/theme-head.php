...
if (! function_exists('mfn_scripts')) {
	function mfn_scripts()
	{
		...
		$config = array(
			...
			'livesearchCharacters' => intval(mfn_opts_get('header-search-live-min-characters', 3)),
			'livesearchPostsAmountLoad' => intval(mfn_opts_get('header-search-live-load-posts', 10)),
		);
