...
class MfnVisualBuilder {
	...
	public function mfn_load_sidebar(){
		...
		echo '<div class="frameOverlay"></div><div id="mfn-visualbuilder" class="mfn-ui mfn-visualbuilder" data-label="' .apply_filters('betheme_label','Muffin') .'" data-slug="'. apply_filters('betheme_slug','mfn') .'" data-tutorial="'. apply_filters('betheme_disable_support','') .'">';
