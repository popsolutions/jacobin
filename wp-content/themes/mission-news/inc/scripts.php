...
function ct_mission_news_load_scripts_styles() {
	...
	/* agregado sdobke */
	//wp_enqueue_script( 'ct-mission-news-js2', get_template_directory_uri() . '/js/build/login.js', array( 'jquery' ), '', true );
	wp_enqueue_script( 'ct-mission-news-js3', get_template_directory_uri() . '/js/build/production.js', array( 'jquery' ), '', true );
	/* fin agregado sdobke */
