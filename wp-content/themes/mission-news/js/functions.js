jQuery(document).ready(function($){
    ...
    $('#mercadopago > input:radio').change(function(){
        if($(this).is(":checked")){
            alert('test');
            $('.woocommerce-checkout-review-order-table > .order-total > .woocommerce-Price-currencySymbol').hide();  
        }
    });
    ...
    function openSearchBar(){
        ...
        if( body.hasClass('display-search') ) { // Si ya está abierto
            ...
            // allow scrolling again
            body.css('overflow', 'auto');
        } else { // Si está oculto lo muestra
	  ...
	  function openLoginBar(){
        ...
        if( body.hasClass('display-login') ) { // Si ya está abierto
            body.removeClass('display-login');
