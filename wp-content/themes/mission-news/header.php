...
<body id="<?php print get_stylesheet(); ?>" <?php body_class(); ?>>
	...
	<div id="overflow-container" class="overflow-container">
		<div id="max-width" class="max-width">
			...
			?>
				<header class="site-header" id="site-header" role="banner" style="-webkit-box-shadow: 0px 10px 13px -7px #000000, 5px 5px 15px 5px rgba(0,0,0,0);box-shadow: 0px 10px 13px -7px #000000, 5px 5px 15px 5px rgba(0,0,0,0);">
					...
					<div class="jota" style="display:none;">
						...
						<svg style="fill:#fff;width:255px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 307.19 66.44">
							<title>Logo Jacobin</title>
							<path d="M25,51A10.3,10.3,0,0,0,35.53,61.46,10.28,10.28,0,0,0,45,55.73c1-2.53,1.1-4,1.1-9.15V22.08H24.33V17.17H51.51v30.1c0,5.8-.69,10.85-4.29,14.53-3,3.08-6.84,4.58-11.69,4.58-9.4,0-15.9-7-15.9-15.36Z" transform="translate(-19.63 -15.46)" />
						</svg>
						<?php echo "</a>"; ?>
			...
			<?php endif; ?><section class="bn-at prt-x">
				<div class="bn-at__container"><?php the_ad(17333); ?>
				</div>
			</section>


			<?php do_action(
				'ct_mission_news_after_header'
			); ?>
